 ...
 * generation.
 */
@objc public class WalmartItemApiRequestHandlerProvider: RequestHandlerProvider, WalmartItemApiRequestHandlerDelegate {
    /**
     * - Parameter config : Optional config object that can be passed to an api impl provider.
     */
    init(handlerConfig: WalmartItemApiConfig? = nil) {
        super.init(config: handlerConfig)
    }

    public func registerFindItemsRequestHandler() {
        // TODO: Needs to be implemented.
    }

    public func registerAddItemRequestHandler() {
        // TODO: Needs to be implemented.
    }
}

// DO NOT rename this class as this naming convention is used when a container is generated.
public class WalmartItemApiConfig: RequestHandlerConfig {}
